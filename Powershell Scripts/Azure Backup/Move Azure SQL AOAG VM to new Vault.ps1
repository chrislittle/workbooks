...
# Get the container & backup items details and disable protection for MSSQL Cluster databases
...
$currentsqlitems = Get-AzRecoveryServicesBackupItem -BackupManagementType AzureWorkload -WorkloadType MSSQL -Name "availability group name"
