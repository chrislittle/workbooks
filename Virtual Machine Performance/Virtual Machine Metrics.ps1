...
$cpufinal | ft @{Label=”Average CPU Percentage”;Expression= {“{0:P}” -f ($_.average / 100)}}
...
$memfinal | ft @{Label=”Minimum Available Memory GB”;Expression= {“{0:N2}” -f ($_.minimum / 1073741824)}}
...
$vmcachediopsfinal | ft @{Label=”Maximum VM Cached IOPS”;Expression= {“{0:P}” -f ($_.maximum / 100)}}
...
$vmuncachediopsfinal | ft @{Label=”Maximum VM Uncached IOPS”;Expression= {“{0:P}” -f ($_.maximum / 100)}}
...
$osdiskiopsfinal | ft @{Label=”Maximum OS Disk IOPS”;Expression= {“{0:P}” -f ($_.maximum / 100)}}
...
$datadiskiopsfinal | ft @{Label=”Maximum Data Disk IOPS”;Expression= {“{0:P}” -f ($_.maximum / 100)}}